...
import 'package:kickoff_shop/widgets/product_card.dart';
import 'package:kickoff_shop/screens/productlist_form.dart';

class MyHomePage extends StatelessWidget {
  MyHomePage({super.key});

  final String npm = '2406495741'; // NPM
  final String name = 'Nezzaluna Azzahra'; // Nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "KickOff Shop" dengan teks putih dan tebal.
        title: const Text(
          'KickOff Shop',
